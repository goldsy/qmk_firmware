 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Ctrl | FN4  | GUI  | Alt  | Hyper|LOWER |NumLyr|      |SPACE |RAISE | Hyper| Alt  | GUI  | Fn4  | Ctrl |
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_QWERTY] = KC_KEYMAP(
  //,--------+------+----+----+----+----+----.    ,----+----+----+----+-----+------+--------.
  ...
  //|--------+------+----+----+----+----+----|    |----+----+----+----+-----+------+--------|
     LCTRL   , AJST ,LGUI,LALT,HYPR,LOWR,NUM ,     SPC ,RASE,HYPR,RALT, RGUI, AJST , RCTRL
  //`--------+------+----+----+----+----+----'    `----+----+----+----+-----+------+--------'
  ),
 ...
 */
  ...
  [_NAV_LYR] = KEYMAP(
    ...
    _______,___x___,_______, _______, _______, ___x___, ___x___, _______, ___x___, _______, _______, _______, ___x___, _______
  ),
